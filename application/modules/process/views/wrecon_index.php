...
<center><h3>With Recon Transaction Merchants</h3></center>
<div class="row-div search-div">
<form method="get" id="search-form" action="javascript:" class="search-wrapper" autocomplete="off" data-page="wrecon">
...
<form method="post" action="process/wrecon/gen_pa" class="form-loader" name="submitForm" id="submitForm">

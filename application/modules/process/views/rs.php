...
<?php if($generate != 0):?>
<div class="pdf_pa">
	<a class="btn btn-warning btn-pdf" href="pdf_rs/group_gen" target="_self">DOWNLOAD GENERATED REIMBURSEMENT SUMMARY</a>
</div>
<?php endif;?>

<div class="row-div serve-tbl" id="list_tbl">
<p class="date_coverage">Date coverage up to <span id="date_coverage"></span></p>
<form method="post" action="process/rs/gen_rs" class="form-loader" name="submitForm" id="submitForm">

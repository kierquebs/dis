...
<div id="container">
	...
	<h1>AGREEMENT</h1>
	<div class="body">					
		<input type="number" name="agr_input" placeholder="ENTER AGREEMENT_ID"/>
	...
	<h1>ACCOUNT</h1>
	<div class="body">		
		<input type="number" name="acc_input" placeholder="ENTER COREPASS_ID" />
		<input type="submit" name="people_id" value="GET PEOPLE ID" />
		<input type="submit" name="sprole_id" value="GET SPROLE ID" />
		<input type="submit" name="contact_id" value="GET CONTACTDATA ID" />
		<input type="submit" name="company_info" value="GET COMPANY INFO" />
	</div>		
	</form>	
	<hr />	
	<div class="result">
		...
		?>
		<h4><?php 
		if(isset($_POST['agr_input']) && $_POST['agr_input'] != null) echo 'AGREEMENT ID: '.$_POST['agr_input'];

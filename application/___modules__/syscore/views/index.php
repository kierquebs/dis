...
<div id="container">
	...
	<div id="body">
		<ul>
			...
			<li>Upload Merchant Fee <a href="/mp_dis/automate/upload_fee" target="_new">run module</a></li>
			<li>Update Navision Data <a href="/mp_dis/automate/update_nav" target="_new">run module</a></li>
		<ul>
	</div>
	<hr />	

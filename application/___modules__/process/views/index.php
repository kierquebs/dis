...
<form method="get" id="search-form" action="javascript:" class="search-wrapper">
	<div class="search-txt-div">
		...
		<input type="text" name="search" class="auto-company form-search form-control" style="width:450px" placeholder="ENTER LEGAL NAME" />
		...
		<a href="Pdf_pa/group_gen" target="_blank">click for download</a>	
	</div>		
</form>
</div>

<div class="row-div serve-tbl">
<form method="post" action="javascript:" class="form-loader"  id="submitForm">
...
<thead class="thead-default">				
	<tr>
		...
		<th>MERCHANT<div class="queue-th-span"><span>NAME</span><span>ID</span></div></th>

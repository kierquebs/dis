...
<head>
<meta charset="utf-8">
<title>Pluxee PH Digital Interface Service</title>
...
<body>
<header id="header">
	<?php /*<h2 style="text-align:center; color:white; background-color:red">PLEASE DO NOT USE ! STILL UNDER MAINTENANCE ! KINDLY CONTACT I.T ADMIN</h2>*/?>
    <div class="wrapper clearfix">
        <i class="icon-mob-menu visiblePhone">&nbsp;</i>
        <div class="logo">
            <!-- <a href="#" target="_self"><img src="assets/images/logo.png" alt="sodexo" /></a> -->
			<a href="#" target="_self"><img src="assets/images/pluxee-logo.png" alt="pluxee" /></a>
        </div>		
